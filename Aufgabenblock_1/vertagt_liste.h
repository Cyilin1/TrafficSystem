...
namespace vertagt
{
    ...
    public:
        ...
        //        void clear() { p_aktionen.push_back(std::make_unique<VClearAktion<T>>(p_objekte)); }
        ...
        void push_back(T obj)
        {
            ...
            p_aktionen.push_back(std::make_unique<VPushBack<T>>(p_objekte, obj));
        }

        void push_front(T obj)
        {
            // Aktionselement für PushBack auf Liste erzeugen
            p_aktionen.push_back(std::make_unique<VPushFront<T>>(p_objekte, obj));
        }
